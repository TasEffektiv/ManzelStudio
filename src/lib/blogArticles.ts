...
export const blogArticles: Record<string, Article> = {
  ...
  "custom-home-design-checklist": {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Understanding these factors early - ideally through a proper [site assessment](/site-assessment) - can help avoid designing a home that later requires expensive modifications.",
        ],
      },
      {
      ...
      },
      {
        ...
        list: [
          ...
          "Lighting",
          "Seating",
          "Connection with dining areas",
          "Access to outdoor entertaining",
        ],
        paragraphs: [
    ...
    conclusion: [
      ...
      "Most importantly, involve your designer and builder early. Experienced professionals can help identify opportunities, constraints and potential costs before decisions become expensive to change.",
